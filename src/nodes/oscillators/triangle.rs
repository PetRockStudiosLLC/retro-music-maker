...
impl TriangleOscillator {
    pub fn new(id: String) -> Self { Self { id, frequency: 440.0, amplitude: 0.3, phase: 0.0 } }
}

impl Node for TriangleOscillator {
    fn id(&self) -> &str { &self.id }
    fn name(&self) -> &str { "TriangleOscillator" }
    ...
    fn process(&mut self, block_size: BlockSize, _input: Option<&[f32]>) -> AudioBuffer {
        ...
        for _ in 0..block_size {
            let sample = 4.0 * (self.phase - (self.phase as i32) as f64 - 0.5).abs() - 1.0;
